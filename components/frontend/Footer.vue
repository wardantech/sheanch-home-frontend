                    ...
                    <b-row>
                        <b-col lg="3" md="4">
                            <div class="footer-widget">
                                <b-img src="../../assets/frontend/images/footer_logo.png" class="footer-widget-img"></b-img>
                                    ...
                                    <div class="footer-widget">
                                        ...
                                        <b-link href="#" class="other-store-link">
                                            <div class="other-store-app">
                                                <div class="app-icon">
                                                    <b-img width="40" src="../../assets/frontend/images/icons/google-play.png" alt="Google play"></b-img>
                                                </div>
                                                <div class="app-text">
                                                    Google Play
                                        ...
                                        <b-link href="#" class="other-store-link">
                                            <div class="other-store-app">
                                                <div class="app-icon">
                                                    <b-img width="40" src="../../assets/frontend/images/icons/app-store.png" alt="Apple store"></b-img>
                                                </div>
                                                <div class="app-text">
                                                    App Store
