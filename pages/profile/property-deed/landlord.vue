                ...
                <DataTable id="dataTable" :columns="columns" :sortKey="sortKey" :sortOrders="sortOrders" @sort="sortBy"
                  ...
                  <tr v-for="(value,i) in values" :key="value.id">
                    ...
                    <td>
                      ...
                      <nuxt-link :to="{name:'profile-property-ads-id-show', params: { id: value.property_ad_id }}" rel="tooltip"
                                 class="btn btn-sm btn-warning btn-simple"
                                 title="View Ad">
                        <font-awesome-icon icon="fa-solid fa-eye"/>
                      </nuxt-link>

                      <nuxt-link :to="{name:'profile-profile-id-show-tenant', params: { id: value.landlord_id }}" rel="tooltip"
