              ...
              <div>
                <form @submit.prevent="store">
                  <b-row>
                    ...
                    <b-col md="6">
                      <b-form-group label="Select property types">
                  ...
                  <b-row>
                    ...
                    <b-col lg="4" md="4" sm="12">
                      <b-form-group label="Select sale type">
                    ...
                    <b-col lg="4" md="4" sm="12">
                      <b-form-group label="Select lease type">
                        <select v-model="form.lease_type" class="form-control custom-input-control">
                          <option value="">Select lease type</option>
                          <option value="1">Commercial</option>
                          <option value="2">Residential</option>
                        </select>
                        <strong class="text-danger" style="font-size: 12px" v-if="errors.lease_type">{{
                            errors.lease_type[0]
                        }}</strong>
                      </b-form-group>
                    </b-col>
                    ...
                    <b-col md="3">
                      <b-form-group label="Amount">
                        <b-form-input @input="utilityAmount(n, utility)" :id="'utility_amount' + n" min="1"
                          class="custom-form-control" type="text" placeholder="Area Size"></b-form-input>
                        <strong class="text-danger" style="font-size: 12px" v-if="errors.area_size">{{
                            errors.area_size[0]
                        }}</strong>
                      </b-form-group>
